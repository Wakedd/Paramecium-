...
int* value g_aspectRatioThreshold = 0.8;  // Added aspect ratio threshold variable
...
int main()
{
    ...
    cv::createTrackbar("Aspect Ratio Threshold", "Segmented Image", &g_aspectRatioThreshold, 1.2, onAspectRatioThresholdChange);
